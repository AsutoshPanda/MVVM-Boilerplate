package com.asutosh.mvvmsample.view.adapter;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<NicePlacePojo> mNicePlaces = new ArrayList<>();
    private Context mContext;

    public RecyclerAdapter(Context context, List<NicePlacePojo> nicePlaces) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        // Set the name of the 'NicePlacePojo'
